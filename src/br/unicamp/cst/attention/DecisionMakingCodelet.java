...
public class DecisionMakingCodelet extends Codelet {
    ...
    private static final double GUASSIAN_WIDTH_EXOGENOUS_SONAR = 500;
    private static final double GUASSIAN_WIDTH_EXOGENOUS_IOR_SONAR = 500;
...
//                    t_max,
        ...
        for(j = 0; j < sensorDimension; j++){
            ...
            attMap_sizeMinus1.add(new Float(1));
        }
