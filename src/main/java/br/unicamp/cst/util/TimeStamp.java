...
public class TimeStamp {
	...
	{
		if (isParseable( ts, "HH:mm:ss" ))
		{
			return ( getLongTimeStamp( ts, "HH:mm:ss" ) );
		}
		else if (isParseable( ts, "HH:mm" ))
		{
			return ( getLongTimeStamp( ts, "HH:mm" ) );
		}
		else if (isParseable( ts, "dd/MM/yyyy HH:mm:ss" ))
		{
			return ( getLongTimeStamp( ts, "dd/MM/yyyy HH:mm:ss" ) );
		}
		else if (isParseable( ts, "dd/MM/yyyy HH:mm" ))
		{
			return ( getLongTimeStamp( ts, "dd/MM/yyyy HH:mm" ) );
		}
		else if (isParseable( ts, "dd/MM/yy HH:mm:ss" ))
		{
			return ( getLongTimeStamp( ts, "dd/MM/yy HH:mm:ss" ) );
		}
		else if (isParseable( ts, "dd/MM/yy HH:mm" ))
		{
			return ( getLongTimeStamp( ts, "dd/MM/yy HH:mm" ) );
		}
		else if (isParseable( ts, "dd/MM/yyyy" ))
		{
			return ( getLongTimeStamp( ts, "dd/MM/yyyy" ) );
		}
		else if (isParseable( ts, "dd/MM/yy" ))
		{
			return ( getLongTimeStamp( ts, "dd/MM/yy" ) );
		}
		else if (isParseable( ts, "d/M/yy" ))
		{
			return ( getLongTimeStamp( ts, "d/M/yy" ) );
		}
		else if (isParseable( ts, "M/d/yyyy" ))
		{
			return ( getLongTimeStamp( ts, "M/d/yyyy" ) );
		}
		else if (isParseable( ts, "M/d/yy" ))
		{
			return ( getLongTimeStamp( ts, "M/d/yy" ) );
		}
		else
		{
			return ( 0L );
