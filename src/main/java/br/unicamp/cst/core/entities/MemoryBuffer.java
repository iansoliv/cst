...
public class MemoryBuffer {
	 ...
	 */
	private final ArrayList<MemoryObject> memoryObjects;
	...
	private final RawMemory rawMemory;

	/**
	 * Safe access through reentrant locks.
	 *
	 * @param accesing the accessing Codelet
	...
	{
		ArrayList<MemoryObject> all = new ArrayList<>();
