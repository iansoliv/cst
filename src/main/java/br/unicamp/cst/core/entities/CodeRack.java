...
/**
 *
 * Following Hofstadter and Mitchell "The copycat project: A model of mental
 * fluidity and analogy-making". Pool of all alive codelets in the system. The
 * whole arena in the Baars-Franklin metaphor.
 *
...
public class CodeRack {
	 ...
	 *
	 * @param allCodelets the allCodelets to set
	 */
	 ...
	 * @param broadcast list of memory objects which were broadcast lately
	 * (treated as input memories).
	...
	public void start()
	{
		this.getAllCodelets().forEach( (Codelet co) ->
		{
			synchronized (co)
			{
				co.start();
